...
How would you create a scatterplot of `iucn_threat_count_species` (y variable) against the total sum of bird, tree, reptile, and plant species (x variable) in each county in California? 
