...
schedDF <- googlesheets4::read_sheet("https://docs.google.com/spreadsheets/d/1J_RpbtCo-9KZ9FxQ6fJsenTflXCHfilwhejDOqCeVHs/edit?usp=sharing",sheet = "FinalVersions",col_types="cccc")
schedDF %<>% dplyr::select(`Group Number`,'Hypothesis','Approach')

schedDF %>% 
  htmlTable::addHtmlTableStyle(col.rgroup = c("#fb9a99","#fdc086","#ffff99","#ccebc5","#b3cde3","#decbe4","#bc98b5"
  )) %>%
...
### Multiple linear regression with an interaction effect

Below, I will show you how you can specify an [interaction effect](https://www.theanalysisfactor.com/interpreting-interactions-in-regression/) ([more involved explainer here with an `R` example](https://education.arcus.chop.edu/understanding-interactions/)) in a multiple linear regression, or a regression model which has more than one predictor variable.
