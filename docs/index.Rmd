...
* For the first two weeks of course, we are tentatively going to meet on Zoom for lecture and lab. Please refer to the [Sakai Zoom Pomona tab](https://sakai.claremont.edu/portal/directtool/849bf64f-4434-4de3-a6d9-ca3a71a16b7d/) for call links.
* Lecture: Seaver South Room 52
* Lab: Seaver Biology Room 140 or the Bernard Field Station Outdoors Classroom when posted.

**Schedule**: Tuesdays & Thursdays, 9:35-10:30am PST (January-May 2022), Labs Thursdays 1:15-5pm PST

**Office Hours**: I am always happy to talk to you. Please schedule a chat at my [Calendly](https://calendly.com/chchang47/small-group-meetings).
...
* Case study presentation and discussion facilitation: 15%
  + Case study presentation: 10%
  + Discussion facilitation: 5%
* California county conservation analysis: 20%
  + Presentation: 5%
  + Report: 15%
