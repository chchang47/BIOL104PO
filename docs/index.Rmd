...
* *Data management, analysis, and visualization*: This course has a computational lab where you will be able to develop skills in statistical programming using the `R` programming language. I do not assume any prior experience with programming.
* *Lived experience*: As conservation scientists, our views are inherently shaped by our past experiences. In the course, you will read papers on environmental engagement and you will apply and interrogate these theories in your own class project. 
...
**Location**: [Zoom](https://sakai.claremont.edu/portal/directtool/1d66a36a-4f57-4483-bd3c-4eee23e39898/)
...
* Formative content and coding assessments (10%)
* Facilitating discussion and providing incisive discussion points (students submit discussion topics/questions) (20%)
...
A key component of my role as an instructor is office hours. During office hours, I am available to help you work through any problems, questions, or thoughts you have about the course.
...
*Academic integrity*: Academic honesty is a core value of the Pomona College and the Claremont Colleges. Plagiarism undermines academic integrity and is a threat to communal ethics. I will assign plagiarized assignments a failing grade and will report any instance of plagiarism to the College.
...
| 2/9  | Why should society care? Ecosystem services, manipulating `data.frame`s in `R` |  [Conservation Biology for All, Chapter 3](https://conbio.org/images/content_publications/Chapter3.pdf); [Valuation of Ecosystem Services](https://www.youtube.com/watch?v=q8AZHtF2f50); @tallis2009mapping; @cardinale2012biodiversity | <!--Theme 2: Problems and some limited solutions; muradian2013payments?-->
| 2/16 | Habitat loss, performing grouping and data merging operations in `R` | [Conservation Biology for All, Chapter 5](https://conbio.org/images/content_publications/Chapter5.pdf); @tilman1994habitat; @mueller2012closing |
| 2/23 | Conservation in practice: Protecting endangered species, generating plots in `R` | @rohlf1991six; [Wild Hope, Chapter 3](https://www.press.uchicago.edu/ucp/books/book/chicago/W/bo13823467.html); [Safe Harbors and RCWs](https://www.youtube.com/watch?v=fNWC4fTUU08) |
| 3/2  | Over-exploitation, visualizing different types of data | [Conservation Biology for All, Chapter 6](https://conbio.org/images/content_publications/Chapter6.pdf); @dirzo2014defaunation; @osuri2016contrasting |
| 3/6  | Project 1 due | |
| 3/9  | Spring recess | |
| 3/16 | Conserving harvested species, plotting multiple variables |  @mangel1996principles; [Fisheries Economics Video](https://www.youtube.com/watch?v=7DNhqtYf47E); [Diekert pages 1-5](https://www.uio.no/studier/emner/sv/oekonomi/ECON4925/h10/undervisningsmateriale/lecture_11-12_renew(1511).pdf) | 
| 3/23 | Climate change, performing linear regressions and evaluating residuals   | [Conservation Biology for All, Chapter 8](https://conbio.org/images/content_publications/Chapter8.pdf); @pacala2004stabilization; @thomas2004extinction |
| 3/30 | Consumer behaviors and invasive species, writing and applying functions | [Conservation Biology for All, Chapter 7](https://conbio.org/images/content_publications/Chapter7.pdf); @chang2016international | <!--Theme 3: Solutions-->
| 4/6  | How do we track population recovery? (And conversely, detect when species are in trouble?), interacting with biodiversity data | [Morris, Doak, et al., Chapters 1, 2, and 4](https://www.cbd.int/doc/pa/tools/A%20Practical%20Handbook%20for%20Population%20Viability%20Analysis.pdf) | <!--Week 4-->
| 4/13 | How do we prioritize locating nature reserves given limited resources? Parks and people or people vs. parks? | @ando1998species; @margules2000systematic; @balmford2003should; @adams2007people | <!-- @watson2011systematic;-->
| 4/20 | Conservation as a problem of environmental public goods | [Public vs. Private Goods](https://www.youtube.com/watch?v=E1v5eRs0_fw); @ostrom1999revisiting; @agrawal2008changing; @burivalova2017critical; [Conservation Biology for All, Ch. 14](https://conbio.org/images/content_publications/Chapter14.pdf) | <!--@levin2014public; @dietz2003struggle;-->
| 4/27 | Decisions at the scale of individuals and societies | @stern1992psychological; @larigauderie2010intergovernmental; @kahan2012polarizing; @pascual2017valuing; [Montreal Protocol](https://www.youtube.com/watch?v=OINKJNWtSiE); [Lessons from Kyoto](https://www.youtube.com/watch?v=bcxL7jN4akw); [Inequality between countries](https://www.youtube.com/watch?v=B11kASPfYxY) | <!--@dunlap2000NEP;-->
| 5/4  | Course retrospective, Final project due | |
