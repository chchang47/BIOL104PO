...
1. Log-in at [https://rstudio.cloud](https://rstudio.cloud/spaces/207567/)
...
15. When you have completed the first `swirl` course, please navigate to the [Gradescope POM](https://sakai.claremont.edu/portal/directtool/bed484e9-cce5-4661-9413-5cd48ecea551/) subpage in our Sakai site and select the correct option for the `Completion of swirl class (Basic Building Blocks)` assignment.